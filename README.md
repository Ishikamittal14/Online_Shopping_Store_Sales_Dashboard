...
The goal is to enable business stakeholders to make data-driven decisions by identifying top-performing areas and improvement opportunities.
...
| Geography | Country/Region, Postal Code, Region |
...
- **Map:** Sales performance by State or Region  
- **Slicers:** Interactive filters for Region, Segment, and Category  
...
- Higher discounts slightly reduced profit margins.  
- Overall, the business showed consistent growth across multiple product lines.
...
|------------|-------------|
| `Online_Shopping_Store_Dashboard.pbix` | Power BI dashboard file |
| `PowerBI_Complete_Sales_Dataset.xlsx` | Excel dataset used for analysis |
| `Online_Shopping_Store_PowerBI_Report.pdf` | PDF report with project summary |
